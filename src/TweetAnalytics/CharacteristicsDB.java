...
public class CharacteristicsDB {
	...
	DB db;
	DBCollection allUsersCollection;//collection with the characteristics of all the users
	DBCollection selectedUsersCollection;//collection with the selected users' characteristics
	...
	//
	public void insertSimpleUser(int id, int numberOfFollowers, int numberOfFriends, int accountAge){
		...
		characteristics.put("fraction", (float)numberOfFollowers / numberOfFriends);
	...
	public void insertSelectedUser(int id, int numberOfFollowers, int numberOfFriends, int accountAge, int numberOfTweets,
			     int numberOfRetweets, int numberOfReplies, int numberOfMentions, int numberOfOthersRetweets, 
			     int numberOfHashtags, int numberOfHashtagTweets, int numberOfUrlTweets, int multipleTweets, String mostUsedSource,
			     int numberOfUniqueUrls, int numberOfUniqueDomains){
		BasicDBObject characteristics = new BasicDBObject();
		...
		simpleNumbers.put("fraction", (float)numberOfFollowers / numberOfFriends);
		...
		simpleNumbers.put("average_retweets_per_tweet", (float)numberOfOthersRetweets/numberOfTweets);
		simpleNumbers.put("average_hashtags_per_tweet", (float)numberOfHashtags/numberOfTweets);
		simpleNumbers.put("hashtag_tweets_percentage", ((float)numberOfHashtagTweets/numberOfTweets)*100);
		simpleNumbers.put("url_tweets_percentage", ((float)numberOfUrlTweets/numberOfTweets)*100);
		...
		uniqueCharacteristics.put("number_of_unique_domains", numberOfUniqueDomains);
