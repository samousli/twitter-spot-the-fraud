...
public class TrendList {
	...
	/*
	 * None of the trends are deleted. Every time a new trend tracking list is
	 * to be generated The whole collection is filtered down to trends which are
	...
	public String[] getNewTrendTracker() {
		...
		// Using query instead of name field to filter out substrings that don't
		// fully match
